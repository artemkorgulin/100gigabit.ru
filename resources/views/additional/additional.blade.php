...
<div class="container left full-width">
    ...
    <ul class="collection with-header">
        ...
        <li >
        <table class="additional"> <!-- add materialize classes, as desired -->
            <thead>
            ...
            <tr class="tablesorter-ignoreRow collection-item">
                <th colspan="7" class="ts-pager form-horizontal">
                    ...
                    @can('create') <!-- РТПЧЕТСЕН РТБЧБ -->
                        ...
                        <div class="row right valign-wrapper add-user-button"><a class="col s12 m12 left-align" href="/additional/create">Добавить сервис</a></div>
                    @endcan
                </th>
            </tr>
            </tfoot>
            ...
            @foreach($users as $user)
                <tr class="collection-item">
                    <td><div class="col s12 m6 l1"><a href="/showadditional/{{$user->services_id}}">({{$user->services_id}})</a></div></td>
                    <td><div class="col s12 m6 l3"><a href="/showadditional/{{$user->services_id}}">{{$user->name}}</a></div></td>
                    <td><div class="col s12 m6 l3"><a href="/showadditional/{{$user->services_id}}">{{$user->price}}</a></div></td>
                    <td><div class="col s12 m6 l3"><a href="/showadditional/{{$user->services_id}}">{{$user->created_at}}</a></div></td>
                    <td><div class="col s12 m6 l2"><a href="/showadditional/{{$user->services_id}}/"><i class="material-icons">delete</i></a></div></td>
                </tr>
            @endforeach
            </tbody>
        </table>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function($) {
            ...
            .tablesorterPager({
                ...
                container: $("table.additional .ts-pager"),
